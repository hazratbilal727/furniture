...
export default function ProfileDetailsPage() {
  ...
  return (
    <main className="profile-page profile-details-page">
      ...
      <p className="profile-details-intro">
      ...
      >
        <label>
          Full name
          <input defaultValue="Muntazir Bukhari" />
        </label>
        <label>
          Email address
          <input type="email" defaultValue="hello@muntazirandsons.com" />
        </label>
        <label>
          Phone number
      ...
      {saved && (
        <p className="profile-details-status" role="status">
